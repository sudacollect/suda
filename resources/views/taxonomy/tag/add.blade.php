    ...
    <div class="container-fluid">
        ...
        <div class="col-12 suda_page_body">
                  ...
                  <div class="mb-3 row {{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="name" class="form-control" id="inputName" placeholder="{{ __('suda_lang::press.input_placeholder',['column'=>__('suda_lang::press.tags.name')]) }}">
                        @if ($errors->has('name'))
                  ...
                  <div class="mb-3 row {{ $errors->has('slug') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="slug" class="form-control" id="inputName" placeholder="{{ __('suda_lang::press.slug') }}">
                        <span class="help-block">
