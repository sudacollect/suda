                    ...
                    <form class="form-ajax" role="form" method="POST" action="{{ admin_url('user/organization/save') }}">
                      ...
                      <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <label for="name">
                            ...
                            <input type="text" name="name" class="form-control" id="inputName" placeholder="{{ trans('suda_lang::press.input_placeholder',['column'=>trans('suda_lang::press.organization_name')]) }}">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input type="checkbox" class="form-check-input" name="disable" placeholder="是" value="0" checked>
