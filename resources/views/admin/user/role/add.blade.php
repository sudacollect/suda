...
<div class="container-fluid">
    <div class="row suda-row">
        ...
        <div class="page-heading">
            <h1 class="page-title"><i class="ion-create"></i>&nbsp;{{ trans('suda_lang::press.add') }}</h1>
        </div>
                ...
                <div class="card-body">
                    ...
                    <form class="form-ajax" role="form" method="POST" action="{{ admin_url('user/roles/save') }}">
                      ...
                      <div class="form-group row {{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                        <input type="text" name="name" class="form-control" id="inputName" placeholder="{{ trans('suda_lang::press.input_placeholder',['column'=>trans('suda_lang::press.role_name')]) }}">
                        @if ($errors->has('name'))
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-sm-9 checkbox">
                                <input type="checkbox" name="disable" checked> {{ trans('suda_lang::press.enable') }}
                                <span class="help-block">
                                    添加角色后可以设置系统和应用权限
                                </span>
                            </div>
