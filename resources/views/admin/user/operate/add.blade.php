    ...
    <div class="modal-body">
        ...
        <div class="container-fluid">
            ...
            <div class="mb-3{{ $errors->has('username') ? ' has-error' : '' }}">
              ...
              <input type="text" name="username" class="form-control" id="inputName" placeholder="{{ __('suda_lang::press.validation.username') }}" value="" autocomplete="false">
            ...
            <div class="mb-3{{ $errors->has('password') ? ' has-error' : '' }}">
              ...
              <input type="password" name="password" class="form-control" id="inputName" placeholder="{{ __('suda_lang::press.password') }}" value="" autocomplete="new-password">
            ...
            <div class="mb-3">
                <div class="form-check form-check-inline">
                    <input type="checkbox" class="form-check-input" name="superadmin" placeholder="{{ __('suda_lang::press.yes') }}" value="1" >
            ...
            <div class="mb-3">
                <div class="form-check form-check-inline">
                    <input type="checkbox" class="form-check-input" name="enable" placeholder="{{ __('suda_lang::press.yes') }}" value="1" >
