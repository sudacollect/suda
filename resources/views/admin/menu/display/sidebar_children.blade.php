@if($hasChildren)
    <div class="panel-body collapse @if(isset($current_item) && $current_item && ($options->sidemenu_style=='flat')) show @endif sidebar-menu sidebar-menu-item sidebar-menu-{{ $item->slug }}" id="sidebar-menu-{{ $item->slug }}" aria-expanded="true">
