    ...
    <div class="container">
        ...
        <div class="col-sm-12 suda_page_body">
                  ...
                  <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="name" class="form-control" value="{{ $term->term->name }}" id="inputName" placeholder="{{ __('suda_lang::press.input_placeholder',['column'=>__('suda_lang::press.category_name')]) }}">
                        @if ($errors->has('name'))
                  ...
                  <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                    ...
                    <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                      ...
                      <div class="col-sm-6">
                          ...
                          <textarea name="desc" class="form-control" rows=4 placeholder="分类描述">{{ $term->desc }}</textarea>
                      </div>
                    ...
                    <div class="form-group{{ $errors->has('parent') ? ' has-error' : '' }}">
                      ...
                      <div class="col-sm-6">
                          <select name="parent" selectcate="true" placeholder="-上级分类-">
                              ...
                              @include('view_suda::taxonomy.category_options',['cates'=>$categories,'child'=>0,'select'=>$term->parent,'exclude'=>$term->id])
