...
<media-manager inline-template
    ...
    :routes="{{ json_encode([
        'files' => route('sudaroute.admin.mediamanager.get_files'),
        // 'lock' => route('sudaroute.admin.mediamanager.lock_file'),
        // 'visibility' => route('sudaroute.admin.mediamanager.change_vis'),
        'upload' => route('sudaroute.admin.mediamanager.upload'),
        // 'locked_list' => route('sudaroute.admin.mediamanager.locked_list')
    ]) }}"
                            ...
                            <div class="control">
                                <div class="field has-addons">
                                    ...
                                    {{-- <p class="control" v-if="!restrictModeIsOn">
                                        <global-search-btn
                                            route="{{ route('sudaroute.admin.mediamanager.global_search') }}"
            ...
            <section class="__stack-container">
                ...
                <div>
                    ...
                    <div id="loading_files" v-show="loading_files">
                        <div id="loading_files_anim" data-json="{{ suda_asset('mediamanager/lottie/world.json') }}"></div>
                    ...
                    <div id="ajax_error" v-show="ajax_error">
                        <div id="ajax_error_anim" data-json="{{ suda_asset('mediamanager/lottie/avalanche.json') }}"></div>
                    ...
                    <v-touch id="no_files"
                        ...
                        <div id="no_files_anim" data-json="{{ suda_asset('mediamanager/lottie/zero.json') }}"></div>
                ...
                <v-touch class="__stack-files mm-animated"
                    ...
                    <section>
                        <div id="no_search" v-show="no_search">
                            <div id="no_search_anim" data-json="{{ suda_asset('mediamanager/lottie/ice_cream.json') }}"></div>
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="t-val">
                                                        <form action="{{ route('sudaroute.admin.mediamanager.folder_download') }}" method="post" @submit.prevent="ZipDownload($event)">
                                                            {{ csrf_field() }}
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    {{-- zip --}}
                                                    <td class="t-val">
                                                        <form action="{{ route('sudaroute.admin.mediamanager.files_download') }}"
                                                            method="post"
...
{{-- styles --}}
@push('styles')
    <link rel="stylesheet" href="{{ suda_asset('mediamanager/style.css') }}"/>
@endpush
