<section>
    ...
    <div v-if="isActiveModal('imageEditor_modal')"
        ...
        <div class="mm-animated fadeInDown __modal-content-wrapper">
            <image-editor route="{{ route('sudaroute.admin.mediamanager.uploadCropped') }}"
                :no-scroll="noScroll"
                :file="selectedFile"
                :trans="trans">
            </image-editor>
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <div class="modal-card mm-animated fadeInDown">
            ...
            <form action="{{ route('sudaroute.admin.mediamanager.uploadLink') }}" @submit.prevent="saveLinkForm($event)">
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <div class="modal-card mm-animated fadeInDown">
            ...
            <form action="{{ route('sudaroute.admin.mediamanager.new_folder') }}" @submit.prevent="NewFolderForm($event)">
                <section class="modal-card-body">
                    <input class="input" type="text"
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <div class="modal-card mm-animated fadeInDown">
            ...
            <form action="{{ route('sudaroute.admin.mediamanager.rename_file') }}" @submit.prevent="RenameFileForm($event)">
                <section class="modal-card-body">
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <form class="modal-card mm-animated fadeInDown"
            action="{{ route('sudaroute.admin.mediamanager.move_file') }}"
    ...
    <div class="modal mm-animated fadeIn"
        ...
        <div class="modal-card mm-animated fadeInDown">
            ...
            <form action="{{ route('sudaroute.admin.mediamanager.delete_file') }}"
